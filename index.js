...
const CANALETAS_PONTO = {
  "1484826105289506836": { batalhao: "QCG", nome: "CMTG - 001" },
  "1484826106522505237": { batalhao: "QCG", nome: "SUBCMTG - 002" },

  "1484826141364715663": { batalhao: "CORREGEDORIA", nome: "PDO - 60000" },
  "1484826143713398844": { batalhao: "CORREGEDORIA", nome: "PDO - 60001" },
  "1484826147152859267": { batalhao: "CORREGEDORIA", nome: "PDO - 60018" },
  "1484826150596382863": { batalhao: "CORREGEDORIA", nome: "PDO - 60038" },
  "1484826152475430962": { batalhao: "CORREGEDORIA", nome: "PDO - 60040" },
  "1500031721641476266": { batalhao: "CORREGEDORIA", nome: "PDO - 60050" },

  "1484826188932448316": { batalhao: "22BPM", nome: "Comando Batalhão | M-22000" },
  "1484826193306976306": { batalhao: "22BPM", nome: "Sub.Comando Batalhão | M-22001" },
  "1484826202442043496": { batalhao: "22BPM", nome: "CoordOp | M-22002" },
  "1484826205696950454": { batalhao: "22BPM", nome: "Supervisão Regional | M-22003" },
  "1484826208477777940": { batalhao: "22BPM", nome: "CFP | M-22004" },
  "1484826211254534206": { batalhao: "22BPM", nome: "CGP UNO | M-22223" },

  "1484826212844175442": { batalhao: "22BPM", nome: "M-22132 (Duster PM)" },
  "1484826217864499220": { batalhao: "22BPM", nome: "M-22106 (Duster PM)" },
  "1505616011133456625": { batalhao: "22BPM", nome: "M-22136 (Spin 2023)" },
  "1484826219181641738": { batalhao: "22BPM", nome: "M-22146 (Spin 2024)" },
  "1484826222490812428": { batalhao: "22BPM", nome: "M-23111 (Spin 2024)" },
  "1484826225313845299": { batalhao: "22BPM", nome: "M-28100 (Duster)" },
  "1484826228493127730": { batalhao: "22BPM", nome: "M-23117 (Spin 2024)" },
  "1484826231156244481": { batalhao: "22BPM", nome: "M-23140 (Duster)" },
  "1484826235992281088": { batalhao: "22BPM", nome: "M-23151/152 (Creta)" },
  "1484826236869148915": { batalhao: "22BPM", nome: "M-23153/116 (Creta)" },

  "1484826240052494467": { batalhao: "22BPM", nome: "M-23165 (Corolla)" },
  "1484826243017736274": { batalhao: "22BPM", nome: "M-23168 (Corolla)" },

  "1484826246226645002": { batalhao: "22BPM", nome: "RPM UNO (XRE/LANDER)" },
  "1484826250659889262": { batalhao: "22BPM", nome: "RPM DOIS (XRE/LANDER)" },

  "1484826252438147215": { batalhao: "22BPM", nome: "Base Comunitária M-23270" },

  "1484826277939773551": { batalhao: "22BPM", nome: "Patrulha Rural" },
  "1484826281358000259": { batalhao: "22BPM", nome: "RPM TRES (XRE/LANDER)" },

  "1484826320436199544": { batalhao: "FORCA_TATICA", nome: "Comando - M-22001" },
  "1484826323338919957": { batalhao: "FORCA_TATICA", nome: "Tático Comando - M-22011" },
  "1484826325679341598": { batalhao: "FORCA_TATICA", nome: "Tático 90 - M-22090" },

  "1484826330037227520": { batalhao: "FORCA_TATICA", nome: "M-22013 - Tático 13" },
  "1484826331677200506": { batalhao: "FORCA_TATICA", nome: "M-22014 - Tático 14" },
  "1484826336437735485": { batalhao: "FORCA_TATICA", nome: "M-22015 - Tático 15" },
  "1484826339499315294": { batalhao: "FORCA_TATICA", nome: "M-22016 - Tático 16" },
  "1484826343328977020": { batalhao: "FORCA_TATICA", nome: "M-22017 - Tático 17" },
  "1484826352044609547": { batalhao: "FORCA_TATICA", nome: "M-22019 - Tático 19" },
  "1484826356104564816": { batalhao: "FORCA_TATICA", nome: "M-22028 - Tático 28" },

  "1484826357488947222": { batalhao: "FORCA_TATICA", nome: "COMANDO ROCAM" },
  "1484826360412377138": { batalhao: "FORCA_TATICA", nome: "CGP ROCAM (Trail 23)" },

  "1484826364841558069": { batalhao: "FORCA_TATICA", nome: "ROCAM UNO" },
  "1484826375314735194": { batalhao: "FORCA_TATICA", nome: "ROCAM DOIS" },

  "1484826382998569081": { batalhao: "CAVPM", nome: "M-3-550/M-3 555/M-3 547" },

  "1484826386878300242": { batalhao: "CAVPM", nome: "ÁGUIA 10 (AS350-B3)" },
  "1484826389843808308": { batalhao: "CAVPM", nome: "ÁGUIA 19 (AS350-B3)" },
  "1484826393056378901": { batalhao: "CAVPM", nome: "ÁGUIA 23 (AS350) GRAU" },
  "1484826396835713076": { batalhao: "CAVPM", nome: "ÁGUIA 32 (AW109)" },
  "1484826400241225830": { batalhao: "CAVPM", nome: "ÁGUIA 33 (EC135)" },

  "1484826411897458738": { batalhao: "CAEP", nome: "Comando OESTE | E-M05000" },
  "1484826415395242054": { batalhao: "CAEP", nome: "CAEP Comando | E-M05001" },
  "1484826419933614230": { batalhao: "CAEP", nome: "Coordenador CAEP | E-M05002" },
  "1484826421367930943": { batalhao: "CAEP", nome: "E-M05004" },
  "1484826428745711626": { batalhao: "CAEP", nome: "CAEP 90 | E-M05090" },

  "1484826432524910733": { batalhao: "CAEP", nome: "E-M05006" },
  "1484826436299657217": { batalhao: "CAEP", nome: "E-M05008" },
  "1484826440061943879": { batalhao: "CAEP", nome: "E-M05009 / E-M05010" },
  "1484826443002282096": { batalhao: "CAEP", nome: "E-M05011 / E-M05012" },
  "1484826446122975374": { batalhao: "CAEP", nome: "E-M05015 / E-M05016" },
  "1484826447607500841": { batalhao: "CAEP", nome: "E-M05019 • ROCAM" },
  "1484826450921000960": { batalhao: "CAEP", nome: "E-M05020 / E-M05017" },
  "1484826454981218424": { batalhao: "CAEP", nome: "E-M05030/E-M05042" },

  "1484826468918759524": { batalhao: "CAEP", nome: "CPAM5-048" },
  "1484826473876426903": { batalhao: "CAEP", nome: "CPAM5-061" },

  "1508557841051422842": { batalhao: "CPCHOQUE", nome: "COMANDO CPCHOQUE" },
  "1508558769259548703": { batalhao: "CPCHOQUE", nome: "SUBCOMANDO CPCHOQUE" },
  "1508559060104908970": { batalhao: "CPCHOQUE", nome: "COORDENAÇÃO CPCHOQUE" },

  "1508559180645269624": { batalhao: "CPCHOQUE", nome: "CPCHOQUE 005" },
  "1508559202057064589": { batalhao: "CPCHOQUE", nome: "CPCHOQUE 006" },
  "1508562463103258837": { batalhao: "CPCHOQUE", nome: "CPCHOQUE 007" },

  "1484826485301841991": { batalhao: "BAEP", nome: "Comando BAEP" },
  "1484826488577720332": { batalhao: "BAEP", nome: "Sub Comando BAEP" },
  "1484826494370058422": { batalhao: "BAEP", nome: "Coordenador BAEP" },

  "1484826497360334969": { batalhao: "BAEP", nome: "Supervisão BAEP E-07100" },
  "1484826500753653770": { batalhao: "BAEP", nome: "Supervisão BAEP E-07300" },

  "1484826509565759488": { batalhao: "BAEP", nome: "BAEP COMANDO E-07106" },
  "1484826513047031859": { batalhao: "BAEP", nome: "BAEP COMANDO E-07301" },

  "1484826514888589333": { batalhao: "BAEP", nome: "E-07090 BLAZER/TRAIL 22" },
  "1484826518235385948": { batalhao: "BAEP", nome: "E-103/203 SW4" },
  "1484826521574047754": { batalhao: "BAEP", nome: "E-07104/204 TRAIL-12" },
  "1484826526439575552": { batalhao: "BAEP", nome: "E-07104/204/480 TRAIL 12" },

  "1484826538863235072": { batalhao: "BAEP", nome: "E-210/212/213 TRAIL 21/22" },
  "1484826542407155734": { batalhao: "BAEP", nome: "E-214/215/218/220 TRAIL 21" },
  "1484826545754341386": { batalhao: "BAEP", nome: "E-07315/418/470/471" },

  "1484826548753137667": { batalhao: "BAEP", nome: "E-07381 - ROCAM BAEP" },
  "1484826552167436410": { batalhao: "BAEP", nome: "E-07385/389 - ROCAM BAEP" },

  "1484826637877907528": { batalhao: "ROTA", nome: "COMANDO AGUIAR - 91000" },
  "1484826650653888512": { batalhao: "ROTA", nome: "COMANDO ROTA - 91001" },
  "1484826654013652992": { batalhao: "ROTA", nome: "COORDENADOR AGUIAR" },

  "1484826655577997362": { batalhao: "ROTA", nome: "ROTA UNO - 91100" },
  "1484826661542166619": { batalhao: "ROTA", nome: "COMANDO 10 - 91102" },
  "1484826665178890350": { batalhao: "ROTA", nome: "ROTA 90 - 91090" },

  "1484826666743234570": { batalhao: "ROTA", nome: "91110 - TRAILBLAZER" },
  "1484826670925090858": { batalhao: "ROTA", nome: "91111 - TRAILBLAZER" },
  "1484826676104790098": { batalhao: "ROTA", nome: "91112 - TRAILBLAZER" },
  "1484826678445477898": { batalhao: "ROTA", nome: "91128 - TRAILBLAZER" },
  "1484826683847475303": { batalhao: "ROTA", nome: "91132 - TRAILBLAZER" },
  "1484826696929771662": { batalhao: "ROTA", nome: "91142 - TRAILBLAZER" },

  "1484826700117311580": { batalhao: "ROTA", nome: "DEJEM ROTA - 3-387" },

  "1484826721898201250": { batalhao: "ANCHIETA", nome: "COMANDO ANCHIETA - 92000" },
  "1484826724813242408": { batalhao: "ANCHIETA", nome: "SUBCOMANDO ANCHIETA" },
  "1484826728625864794": { batalhao: "ANCHIETA", nome: "COORDENADOR ANCHIETA" },

  "1484826730454843544": { batalhao: "ANCHIETA", nome: "ANCHIETA 1 - 92100" },
  "1484826736288993404": { batalhao: "ANCHIETA", nome: "ANCHIETA 2 - 92200" },
  "1484826739690442833": { batalhao: "ANCHIETA", nome: "ANCHIETA 3 - 92300" },
  "1484826743062925413": { batalhao: "ANCHIETA", nome: "ANCHIETA 4 - 92400" },

  "1484826745655005217": { batalhao: "ANCHIETA", nome: "ANCHIETA 111 - 92111" },
  "1484826747470872607": { batalhao: "ANCHIETA", nome: "ANCHIETA 119 - 92119" },
  "1484826753015742505": { batalhao: "ANCHIETA", nome: "ANCHIETA 205 - 92205" },
  "1484826754819297421": { batalhao: "ANCHIETA", nome: "ANCHIETA 212 - 92212" },
  "1484826757759500358": { batalhao: "ANCHIETA